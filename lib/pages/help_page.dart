        ...
        body: Column(
          children: <Widget>[
            ...
            Container(child: Text(
              'منبع : ویکی پدیا', style: TextStyle(fontSize: 18.0),),)
          ],
        ));
  }
}
